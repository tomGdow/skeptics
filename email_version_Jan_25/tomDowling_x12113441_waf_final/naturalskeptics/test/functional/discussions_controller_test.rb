...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { description: @discussion.description, introduction: @discussion.introduction, title: @discussion.title, user_id: @discussion.user_id }
    end
  ...
  test "should update discussion" do
    put :update, id: @discussion, discussion: { description: @discussion.description, introduction: @discussion.introduction, title: @discussion.title, user_id: @discussion.user_id }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
