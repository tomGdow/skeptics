...
class CommoditiesControllerTest < ActionController::TestCase
  ...
  test "should create commodity" do
    assert_difference('Commodity.count') do
      post :create, commodity: { description: @commodity.description, image_url: @commodity.image_url, name: @commodity.name, price: @commodity.price }
    end
  ...
  test "should update commodity" do
    put :update, id: @commodity, commodity: { description: @commodity.description, image_url: @commodity.image_url, name: @commodity.name, price: @commodity.price }
    assert_redirected_to commodity_path(assigns(:commodity))
  end
